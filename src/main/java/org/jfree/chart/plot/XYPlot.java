...
public class XYPlot extends Plot implements ValueAxisPlot, Pannable, Zoomable,
    ...
    public void draw(Graphics2D g2, Rectangle2D area, Point2D anchor,
        ...
        CrosshairState crosshairState = crosshairOperations(anchor, dataArea, orient);
        ...
        axisStateOperations(g2, parentState, dataArea, axisStateMap);
        ...
        drawMarkersSpecificDataset(g2, dataArea);
        ...
        drawBackgroundAnnotations(g2, info, dataArea, rendererIndices);

        // render data items...
        foundData = renderDataItems(g2, info, dataArea, crosshairState, foundData, datasetIndices);

        // draw foreground annotations
        drawForegroundAnnotations(g2, info, dataArea, rendererIndices);

        // draw domain crosshair if required...
        int datasetIndex = drawDomainCrosshair(g2, anchor, dataArea, orient, crosshairState);

        // draw range crosshair if required...
        drawRangeCrosshair(g2, anchor, dataArea, orient, crosshairState, datasetIndex);

        if (!foundData) {
            drawNoDataMessage(g2, dataArea);
        }

        drawDomainAndRangeMarkers(g2, dataArea, rendererIndices);
	...
	private void drawDomainAndRangeMarkers(Graphics2D g2, Rectangle2D dataArea, List<Integer> rendererIndices) {
	...
	private void drawMarkersSpecificDataset(Graphics2D g2, Rectangle2D dataArea) {
	...
	private boolean renderDataItems(Graphics2D g2, PlotRenderingInfo info, Rectangle2D dataArea,
			CrosshairState crosshairState, boolean foundData, List<Integer> datasetIndices) {
	...
	private void drawBackgroundAnnotations(Graphics2D g2, PlotRenderingInfo info, Rectangle2D dataArea,
	...
	private void drawForegroundAnnotations(Graphics2D g2, PlotRenderingInfo info, Rectangle2D dataArea,
			List<Integer> rendererIndices) {
		for (int i : rendererIndices) {
            XYItemRenderer renderer = getRenderer(i);
            if (renderer != null) {
	...
	private void drawRangeCrosshair(Graphics2D g2, Point2D anchor, Rectangle2D dataArea, PlotOrientation orient,
			CrosshairState crosshairState, int datasetIndex) {
	...
	private int drawDomainCrosshair(Graphics2D g2, Point2D anchor, Rectangle2D dataArea, PlotOrientation orient,
	...
	private void axisStateOperations(Graphics2D g2, PlotState parentState, Rectangle2D dataArea, Map axisStateMap) {
	...
	private CrosshairState crosshairOperations(Point2D anchor, Rectangle2D dataArea, PlotOrientation orient) {
