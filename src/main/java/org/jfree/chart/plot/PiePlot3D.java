...
public class PiePlot3D extends PiePlot implements Serializable {
    ...
    protected void drawSide(Graphics2D g2,
        ...
        if (extent < 0.0) {
            ...
            drawSideClockwise(g2, plotArea, arc, front, back, paint, outlinePaint, drawFront, drawBack, start, extent,
					end);
        }
        else if (extent > 0.0) {  // the pie sections are arranged ANTICLOCKWISE

            drawSideAnticlockwise(g2, plotArea, arc, front, back, paint, outlinePaint, drawFront, drawBack, start,
					extent, end);
	...
	private void drawSideAnticlockwise(Graphics2D g2, Rectangle2D plotArea, Arc2D arc, Area front, Area back,
			Paint paint, Paint outlinePaint, boolean drawFront, boolean drawBack, double start, double extent,
			double end) {
	...
	private void drawSideClockwise(Graphics2D g2, Rectangle2D plotArea, Arc2D arc, Area front, Area back, Paint paint,
			Paint outlinePaint, boolean drawFront, boolean drawBack, double start, double extent, double end) {
