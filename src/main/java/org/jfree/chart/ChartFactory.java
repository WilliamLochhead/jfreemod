...
public abstract class ChartFactory {
    ...
    public static JFreeChart createPieChart(String title, PieDataset dataset,
        ...
        return buildPieChart(title, dataset, previousDataset, percentDiffForMaxScale, greenForIncrease, legend,
				subTitle, showDifference, plot);
    }

	private static JFreeChart buildPieChart(String title, PieDataset dataset, PieDataset previousDataset,
